...
function blob_fixup() {
    case "${1}" in
        ...
        vendor/lib64/mediadrm/libwvdrmengine.so|vendor/lib64/libwvhidl.so)
            ...
            ;;
        vendor/lib/libstagefright_soft_ac4dec.so | vendor/lib/libstagefright_soft_ddpdec.so | \
        vendor/lib/libstagefrightdolby.so | vendor/lib64/libdlbdsservice.so | \
        vendor/lib64/libstagefright_soft_ac4dec.so | vendor/lib64/libstagefright_soft_ddpdec.so | \
